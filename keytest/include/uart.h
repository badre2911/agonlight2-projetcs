...
#define MASTERCLOCK 20000000  //18432000
...
typedef struct {
   ...
   uint8_t     fifoTriggerLevel ;		//!< The receive FIFO interrupt trigger level to be used.
   uint8_t     swflowcontrol ;
   uint8_t     hwFlowControl ;		//!< The hardware flow control to be used
   uint8_t     interrupts;             // Registered interrupts
} xUART;

void init_UART0();
void init_UART1();

extern void uart0_putch(char c);
extern char uart0_getch();
extern void uart0_flush();
extern char uart0_kbhit();
extern char uart0_read();

extern void uart1_putch(uint8_t c);
extern char uart1_getch();
extern void uart1_flush();
extern char uart1_kbhit();
extern char uart1_read();
